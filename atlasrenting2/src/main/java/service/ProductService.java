...
public class ProductService {
	...
	public void deleteProductsByRentalOwnerId(Long rentalOwneridId,long productId) {
		productRepository.deleteById(productId);
  ...
  public List<Product> searchProducts(String name, String category) {
        // Implement the logic to search products based on the provided name and category
    ...
    // Additional methods for managing products (create, update, delete, etc.) can be added here
}
